...
local Window = Rayfield:CreateWindow({
	Name = "Blox Fruits - RED-EYE [CREW]",
	LoadingTitle = "Blox Fruits - RED-EYE [CREW]",
	LoadingSubtitle = "Subscribe to DEEX on YouTube!",
})
...
local TabUtil = Window:CreateTab("TAJMI3")
local SectionUtil = TabUtil:CreateSection("Blox Fruits TAJMI3")
local TabOther = Window:CreateTab("Side GUI's")
local SectionOther = TabOther:CreateSection("Blox Fruits Side GUI's")

local Label = Tab:CreateLabel("Thanks for using RED-EYE [CREW]!")
local Label = TabUtil:CreateLabel("Thanks for using RED-EYE [CREW]!")
local Label = TabOther:CreateLabel("Thanks for using RED-EYE [CREW]!")
local Label = TabMobile:CreateLabel("Thanks for using RED-EYE [CREW]!")
